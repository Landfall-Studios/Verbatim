...
/**
 * Paper implementation of GameConfig, wrapping PaperVerbatimConfig.
 */
public class PaperGameConfig implements GameConfig {

    private final PaperVerbatimConfig config;

    public PaperGameConfig(PaperVerbatimConfig config) {
        this.config = config;
    }
